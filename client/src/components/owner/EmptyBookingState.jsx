...
const EmptyBookingState = () => {
	...
	return (
		<motion.div
			...
			<div className="w-20 h-20 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-6 shadow-inner">
			...
			<div className="flex flex-col sm:flex-row gap-4">
				<button
					...
					className="px-6 py-2.5 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dull transition-all active:scale-95 flex items-center gap-2 cursor-pointer shadow-md">
				...
				<button
					...
					className="px-6 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all active:scale-95 cursor-pointer shadow-sm">
					Manage Your Fleet
				</button>
			</div>
			...
			<div className="mt-12 pt-8 border-t border-gray-100 w-full max-w-2xl">
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
					<div className="space-y-2">
						<div className="w-8 h-8 rounded-xl bg-blue-50 flex items-center justify-center text-blue-500 font-bold text-xs">1</div>
					...
					<div className="space-y-2">
						<div className="w-8 h-8 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-500 font-bold text-xs">2</div>
					...
					<div className="space-y-2">
						<div className="w-8 h-8 rounded-xl bg-purple-50 flex items-center justify-center text-purple-500 font-bold text-xs">3</div>
