...
const InputBox = ({ value, onChange, label, type = 'text', placeholder, title, as = 'input', options = [], rows = 4, icon: Icon }) => {
    ...
    const baseClass = "peer w-full border-2 border-gray-200 rounded-lg py-2 px-3 outline-none focus:border-primary focus:ring-3 focus:ring-primary/40 transition-all duration-300 bg-transparent"
