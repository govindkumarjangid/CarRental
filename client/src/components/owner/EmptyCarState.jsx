...
const EmptyCarState = () => {
	...
	return (
		...
		>
			...
			<p className="text-gray-500 max-w-lg mb-10 leading-relaxed md:text-lg text-md">
			...
			<div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-4xl text-left">
				<div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
					...
					<p className="text-sm text-gray-500 leading-snug">Have your RC, Insurance, and Permit details ready for a smooth listing process.</p>
				</div>
				...
				<div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
					...
					<p className="text-sm text-gray-500 leading-snug">Set hourly rates based on car model, year, and local market demand.</p>
				</div>
				...
				<div className="p-5 bg-gray-50 rounded-xl border border-gray-100">
					...
					<p className="text-sm text-gray-500 leading-snug">Once submitted, our team reviews and approves your listing within 24 hours.</p>
				</div>
			</div>
		</motion.div>
	);
