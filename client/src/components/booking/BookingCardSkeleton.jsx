    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 rounded-lg mt-5 first:mt-12 backdrop-blur-sm border border-gray-200 dark:bg-card-bg dark:border-dark-border animate-pulse">
      ...
      <div className="md:col-span-2">
        <div className="flex items-center gap-2">
          <div className="h-7 w-28 bg-gray-200 dark:bg-surface rounded" />
        ...
        <div className="flex items-start gap-2 mt-4">
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="h-4 w-64 bg-gray-200 dark:bg-surface rounded" />
          </div>
        </div>
      ...
      <div className="md:col-span-1 flex flex-col justify-between items-end gap-6">
        <div className="flex flex-col items-end gap-2 w-full">
          <div className="h-4 w-20 bg-gray-200 dark:bg-surface rounded" />
          <div className="h-8 w-32 bg-gray-200 dark:bg-surface rounded" />
          <div className="h-4 w-36 bg-gray-200 dark:bg-surface rounded mt-2" />
          <div className="h-4 w-40 bg-gray-200 dark:bg-surface rounded" />
        </div>
      </div>
    </div>
