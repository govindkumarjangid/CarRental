const BookingCardSkeleton = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 rounded-lg mt-5 first:mt-12 backdrop-blur-sm border border-gray-200   animate-pulse">

      {/* Column 1: Image and Car details */}
      <div className="md:col-span-1">
        <div className="w-full h-auto aspect-video rounded-lg bg-gray-200  mb-2" />
        <div className="h-6 w-3/4 bg-gray-200  rounded mt-2 mb-2" />
