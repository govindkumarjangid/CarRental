const ChatMessagesSkeleton = () => {
  return (
    <div className="w-full h-full flex-1 flex flex-col min-w-0 overflow-hidden bg-[#efe7de] dark:bg-[#0b141a]">
      {/* HEADER SKELETON */}
      <div className="shrink-0 bg-white/95 dark:bg-second-bg/95 backdrop-blur-md border-b border-gray-200 dark:border-dark-border p-2 md:p-3 flex flex-row items-center justify-between z-10">
        ...
        <div className="absolute inset-0 overflow-y-auto p-4 md:p-6 custom-scrollbar bg-[url('https://i.pinimg.com/736x/8c/98/99/8c98994518b575bfd8c949e91d20548b.jpg')] bg-repeat bg-bg-size-[400px] dark:opacity-90 dark:bg-blend-overlay dark:bg-black/20">
          <div className="flex flex-col min-h-full">
            ...
            <div className="space-y-4 flex flex-col p-1">
              <div className="h-14 shimmer dark:!bg-[#202c33] rounded-2xl rounded-bl-sm w-[60%] md:w-[40%] self-start border border-transparent dark:border-none" />
              <div className="h-14 shimmer bg-[#d9fdd3]! dark:!bg-[#005c4b] rounded-2xl rounded-br-sm w-[70%] md:w-[50%] self-end" />
              <div className="h-14 shimmer dark:!bg-[#202c33] rounded-2xl rounded-bl-sm w-[50%] md:w-[35%] self-start border border-transparent dark:border-none" />
              <div className="h-14 shimmer bg-[#d9fdd3]! dark:!bg-[#005c4b] rounded-2xl rounded-br-sm w-[80%] md:w-[60%] self-end" />
              <div className="h-14 shimmer dark:!bg-[#202c33] rounded-2xl rounded-bl-sm w-[45%] md:w-[30%] self-start border border-transparent dark:border-none" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="shrink-0 p-3 md:p-4 bg-[#f0f2f5] dark:bg-[#202c33] border-t border-gray-200 dark:border-dark-border flex gap-3 z-10">
        <div className="flex-1 h-12 shimmer dark:!bg-[#2a3942] rounded-full" />
