...
const Navbar = () => {
	...
	return (
		<motion.div
			...
			className={`max-w-8xl m-auto flex items-center justify-between h-auto px-4 md:px-16 lg:px-24 xl:px-32 py-4 text-gray-600 border-b border-gray-300 relative z-10 transition-all duration-300 dark:border-gray ${location.pathname === "/" ? "bg-light dark:bg-main-bg" : "bg-white dark:bg-second-bg"
				}`}
		>
			{/* logo  */}
			<Link to="/">
			...
			>
				...
				<div className="flex max-sm:flex-col items-start sm:items-center gap-6">
					<button
						className="cursor-pointer dark:text-gray"
						onClick={() => {
				...
				{/* <div className="flex items-center gap-5">
					<button
						onClick={toggleTheme}
						className=" px-2 py-2 bg-gray-200 dark:bg-second-bg rounded-lg text-sm dark:text-gray cursor-pointer transition-all hover:scale-105 active:scale-95"
					>
						{theme === "dark" ? (
							<iconList.Sun />
						) : (
