		...
		<>
			<div className="max-w-8xl m-auto w-full py-20 px-3">
				<motion.div
					...
					className="flex flex-col md:flex-row md:items-center justify-between px-8 md:pl-14 pt-10 bg-linear-to-r from-primary/80 via-primary/90 to-primary-dull max-w-6xl rounded-xl overflow-hidden md:mx-auto shadow-lg">
					<div className="md:max-w-lg text-left pb-8">
						...
						<button
							...
							className="bg-white text-primary px-6 py-2 rounded-xl hover:bg-gray-100 transition-all active:scale-98 cursor-pointer">
