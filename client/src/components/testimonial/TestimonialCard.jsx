...
const TestimonialCard = ({ review, index }) => {
	...
	return (
		<motion.div
			...
			className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-primary/30 shadow-xs hover:shadow-xl transition-all w-full h-full flex flex-col justify-between cursor-pointer group">
			<div>
